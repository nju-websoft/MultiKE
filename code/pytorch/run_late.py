...
if __name__ == '__main__':
    ...
    for i in range(1, args.max_epoch + 1):
        ...
        if i >= args.start_valid and i % args.eval_freq == 0:
            ...
            # model.valid(args, model, valid_dataloader, embed_choice='avg')
            # model.valid_WVA(args, model, valid_dataloader, test_dataloader)
    ...
    # model.test_WVA(args, model, valid_dataloader, test_dataloader)
